          ...
          <Homepage>
            ...
            <GridRow>
              <HomepageContent>
                <h2>About Me</h2>
                <p>
                  Danger Technologies is a one-man freelance app development studio intended as a creative outlet for things I don't get the
                  chance to work with in my day to day job.
                </p>
                <p />
                <hr />
                <h2>Posts</h2>
